...
class noticeList(QWidget):
    ...
    def initUI(self):
        ...
        employment_rate_btn = QPushButton('상세보기', self.w)
        employment_rate_btn.setFont(QFont(self.basicInfo.font1, 13))
        employment_rate_btn.setGeometry(920, 380, 130, 40)
        employment_rate_btn.setStyleSheet('background-color: rgb(255,255,255); border:1px solid lightgray; ')
