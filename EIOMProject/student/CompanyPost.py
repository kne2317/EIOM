...
class CompanyPost(QWidget):
    ...
    def initUI(self):
        ...
        postBtn.setFont(QFont('맑은 고딕', 13))
        ...
        infoBtn.setFont(QFont('맑은 고딕', 13))
        ...
        contTitle.setFont(QFont('맑은 고딕',13))
