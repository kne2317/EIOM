...
class MyPage(QWidget):
    ...
    def initUI(self):
        ...
        y1_1=QLabel(str(datetime.today().year-2) +"년",self.w)
        ...
        y1_2 = QLabel(str(datetime.today().year - 1) + "년", self.w)
        ...
        y1_3 = QLabel(str(datetime.today().year) + "년", self.w)
        ...
        y2_1 = QLabel(str(datetime.today().year - 2) + "년", self.w)
        ...
        y2_2 = QLabel(str(datetime.today().year - 1) + "년", self.w)
        ...
        y2_3 = QLabel(str(datetime.today().year) + "년", self.w)
        ...
        y3_1 = QLabel(str(datetime.today().year - 2) + "년", self.w)
        ...
        y3_2 = QLabel(str(datetime.today().year - 1) + "년", self.w)
        ...
        y3_3 = QLabel(str(datetime.today().year) + "년", self.w)
        ...
        y4_1 = QLabel(str(datetime.today().year - 2) + "년", self.w)
        ...
        y4_2 = QLabel(str(datetime.today().year - 1) + "년", self.w)
        ...
        y4_3 = QLabel(str(datetime.today().year) + "년", self.w)
